...
';
        ...
        <tbody id="myTable">
            <tr>
                <td>';
			echo LR\Filters::escapeHtmlText($item['username']) /* line 19 */;
			echo '</td>
                <td>';
			echo LR\Filters::escapeHtmlText($item['email']) /* line 20 */;
			echo '</td>
                <td>';
			echo LR\Filters::escapeHtmlText($item['roles']) /* line 21 */;
			echo '</td>
            </tr>
        </tbody>
    </table>
